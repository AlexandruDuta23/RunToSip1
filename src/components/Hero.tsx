    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
          Run to <span className="text-amber-400">Sip</span>
        </h1>
        <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed">
          Join Bucharest's favorite running community every Sunday.<br />
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-12">
          <div className="flex items-center space-x-2 text-white">
            ...
            <span className="text-lg font-semibold">Every Sunday</span>
          </div>
          <div className="flex items-center space-x-2 text-white">
            <MapPin className="h-6 w-6 text-amber-400" />
            <span className="text-lg font-semibold">All Over Bucharest</span>
          </div>
          <div className="flex items-center space-x-2 text-white">
            <Users className="h-6 w-6 text-amber-400" />
            <span className="text-lg font-semibold">Growing Community</span>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            ...
            className="bg-amber-500 hover:bg-amber-600 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2 shadow-lg"
          >
